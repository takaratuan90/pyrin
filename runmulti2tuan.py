...
def command1():
    ...
    subprocess.run(['/content/pyrin/pyipad', '--utxoindex'])

def command2():
    # Lệnh hoặc công việc bạn muốn chạy ở lệnh thứ hai
    subprocess.run(['/content/pyrin/pyrinminer', '--miningaddr', 'pyrin:qzsc50v3h0kg9fyhxeycafsumvtz237dhhucye9ucc8jjd0f3nvnzez6hj5vu'])
